...
class Messanger:
    ...
    def whatsapp(self,message,person):
        ...
        if person in people.keys():
            ...
            self.speech.The_Oracle(f"Ok boss sending {person} a whatsapp message saying that {message}")
            ...
            self.speech.The_Oracle("Ok sir, will send the message but it seem's that the provided number is not on your contact list, should I still send the message Sir")
